...
export const API_PATHS = {
    ...
    AI: {
      GENERATE_QUESTIONS: "/api/ai/generate-questions", //Generate interview question and answers using Gemini
      GENERATE_EXPLANATION:"/api/ai/generate-explanation", // Generate concept explanation using Gemini
    },

    SESSION: {
      CREATE: "/api/sessions/create", //Create anew interview session with questions
